...
#                    'amount_currency': (self_credit and -1 or 1) * amount_cur or (account.currency_id.id and -currency or 0.0)
                }),
                (0, 0, {
                    'name':libelle,
                    'debit':debit,
                    ...
                    'currency_id': cur_id or (account.currency_id.id or False),
#                    'amount_currency': amount_cur or (account.currency_id.id and -currency or 0.0)
#                    'amount_currency': (credit and -1 or 1) * amount_cur or (account.currency_id.id and -currency or 0.0)
                })
            ]
