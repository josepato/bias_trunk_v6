...
report_fields = {
    ...
    'currency':{
        'string':"Currency",
        'type':'selection',
        'selection':[('none',' '),('MN','PESOS'),('USD','DOLARES')], 'default': lambda *a: 'MN'
    },
    'result_selection':{
        'string':"Select",
        'type':'selection',
...
class wizard_financial_reports_aged_client_mn(wizard.interface):
...
wizard_financial_reports_aged_client_mn('financial.reports.aged.client.mn')
