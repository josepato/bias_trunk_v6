...
report_fields = {
    'name':{'string':"Name",'type':'char', 'default': lambda *a: 'Balanza de Comprobación'},
...
class wizard_financial_reports_balance(wizard.interface):
...
wizard_financial_reports_balance('financial.reports.balance')
