...
#       160 2010-06-01 2010-06-30   0 False False True False False 30 0 none True
        ...
        currency = (form['currency'] == 'mn' and 1) or (form['currency'] == 'usd' and 2) or 0
        ...
        print 'Function parameters=',form['account_id'], form['date1'], form['date2'], category, partners, cc, balance, group_by, zero, reconcile, aged, period, currency, partner_type, fyear, journal
