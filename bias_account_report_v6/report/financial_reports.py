...
report_sxw.report_sxw('report.financial.reports_aged', 'res.partner',
		'addons/bias_account_report_v6/report/financial_reports_aged.rml',parser=custom_report,
		header=False)

report_sxw.report_sxw('report.financial.reports_balance', 'res.partner',
		'addons/bias_account_report_v6/report/financial_reports_balance.rml',parser=custom_report,
		header=False)

report_sxw.report_sxw('report.financial.reports_other', 'res.partner',
		'addons/bias_account_report_v6/report/financial_reports_other.rml',parser=custom_report,
		header=False)
