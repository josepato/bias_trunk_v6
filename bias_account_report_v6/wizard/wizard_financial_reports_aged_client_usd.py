...
report_fields = {
    'name':{'string':"Name",'type':'char', 'default': lambda *a: 'Antigüedad de Saldos Clientes'},
    ...
    'currency':{
        'string':"Currency",
        'type':'selection',
        'selection':[('none',' '),('MN','PESOS'),('USD','DOLARES')], 'default': lambda *a: 'USD'
    },
    'result_selection':{
        'string':"Select",
        'type':'selection',
    ...
    'partner_type':{
        'string':"Partner Type",
        'type':'selection',
        'selection':[('none','None'),('customer','Customer'),('supplier','Supplier')], 'default': lambda *a: 'customer',
    },
    'report_zero':{
        'string':"Report Zeros",
        'type':'selection',
...
class wizard_financial_reports_aged_client_usd(wizard.interface):
    ...
    def _get_defaults(self, cr, uid, data, context):
        ...
        account_id = config_id and report_obj.browse(cr, uid, config_id[0]).usd_customer_account_id.id
...
wizard_financial_reports_aged_client_usd('financial.reports.aged.client.usd')
