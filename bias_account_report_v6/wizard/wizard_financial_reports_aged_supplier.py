...
report_fields = {
    'name':{'string':"Name",'type':'char', 'default': lambda *a: 'Antigüedad de Saldos Proveedores'},
    ...
    'partner_type':{
        'string':"Partner Type",
        'type':'selection',
        'selection':[('none','None'),('customer','Customer'),('supplier','Supplier')], 'default': lambda *a: 'supplier',
    },
    'report_zero':{
        'string':"Report Zeros",
        'type':'selection',
...
class wizard_financial_reports_aged_supplier(wizard.interface):
    ...
    def _get_defaults(self, cr, uid, data, context):
        ...
        account_id = config_id and  report_obj.browse(cr, uid, config_id[0]).mn_supplier_account_id.id
...
wizard_financial_reports_aged_supplier('financial.reports.aged.supplier')
