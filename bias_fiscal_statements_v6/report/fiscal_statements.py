...
report_sxw.report_sxw('report.fiscal_statements_balance', 'res.partner',
		'addons/bias_fiscal_statements_v6/report/fiscal_statements_balance.rml',parser=fiscal_statements,
		header=False)
report_sxw.report_sxw('report.fiscal_statements_balance_1', 'res.partner',
		'addons/bias_fiscal_statements_v6/report/fiscal_statements_balance_1.rml',parser=fiscal_statements,
		header=True)
report_sxw.report_sxw('report.fiscal_statements_balance_1_message', 'res.partner',
		'addons/bias_fiscal_statements_v6/report/fiscal_statements_balance_1_message.rml',parser=fiscal_statements,
		header=True)
report_sxw.report_sxw('report.fiscal_statements_income', 'res.partner',
		'addons/bias_fiscal_statements_v6/report/fiscal_statements_income.rml',parser=fiscal_statements,
		header=True)
report_sxw.report_sxw('report.fiscal_statements_income_message', 'res.partner',
		'addons/bias_fiscal_statements_v6/report/fiscal_statements_income_message.rml',parser=fiscal_statements,
		header=True)
