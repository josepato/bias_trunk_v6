...
class account_move_fiscal(osv.osv):
    ...
    _columns = {
        ...
        'rate_id': fields.function(__compute, method=True, type='many2one', relation='account.tax', string='IVA Rate'),#,store=True),
        'iva_payed_na': fields.float('IVA Payed not accredited', digits=(16,2)),
		...
		'amount': fields.function(__compute, method=True, string='Amount', store=True),
        'base': fields.float('Base', digits=(16,2)),
        'ietu': fields.float('IETU', digits=(16,2)),
        'iva': fields.function(__compute, digits=(16,2), method=True, string='IVA',store=True),
        'other': fields.function(__compute, digits=(16,2), method=True, string='Other Expenses',store=True),
        'amount_before_retension': fields.function(__compute, digits=(16,2), method=True, string='Amount Before Retension',store=True),
        'retained_iva': fields.function(__compute, digits=(16,2), method=True, string='Retained IVA',store=True),
        'retained_isr': fields.function(__compute, digits=(16,2), method=True, string='Retained ISR',store=True),
        'total': fields.function(__compute, digits=(16,2), method=True, string='Total',store=True),
    }

    _defaults = {
        'applies': lambda *a: 1,
        'state': lambda *a: 'untransfer',
    }
