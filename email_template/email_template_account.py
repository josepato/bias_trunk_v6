...
#                try:
                    ...
                    print "core_obj.user_id", core_obj.user.company_id
                    print "core_obj.user_id.name"
                    print core_obj.user.company_id.name
                    payload_part['Organization'] = "My Organization" #tools.ustr(core_obj.user.company_id.name)
