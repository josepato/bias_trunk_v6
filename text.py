...
centaine = {
	0:'', 1: 'CIEN', 2:'DOSCIENTOS', 3:'TRESCIENTOS',4:'CUATROCIENTOS', 5:'QUINIENTOS', 6:'SEISCIENTOS', 7:'SETECIENTOS',
...
def get_money_name(code, fmt=0):
	my_name = {'MN':['PESOS','Pesos'],
		    'USD':['DOLARES AMERICANOS','Dolares Americanos']
		    }
	if my_name.get(code, False):
		return my_name[code][fmt]
	else:
		return code
	return my_name[code][fmt]
